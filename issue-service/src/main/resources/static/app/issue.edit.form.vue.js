...
`,
    ...
    methods: {
        save() {
            ...
            window.axios.put(`/api/issues/${this.issue.id}`,
                this.issue,
                {
                    headers: {
        ...
        remove() {
            ...
            let accessToken = localStorage.getItem('token')
            window.axios.delete(`/api/issues/${this.issue.id}`,
                {
                    headers: {
                        Authorization: `Bearer ${accessToken}`
                    }
        ...
        editComment(comment) {
            ...
            let accessToken = localStorage.getItem('token')
            window.axios.put(`/api/issues/${this.issue.id}/comments/${comment.id}`,
                {body: comment.body},
                {
                    headers: {
                        Authorization: `Bearer ${accessToken}`
        ...
        deleteComment(comment) {
            ...
            let accessToken = localStorage.getItem('token')
            window.axios.delete(`/api/issues/${this.issue.id}/comments/${comment.id}`,
                {
                    headers: {
                        Authorization: `Bearer ${accessToken}`
                    }
        ...
        createComment(event) {
            ...
            let accessToken = localStorage.getItem('token')
            window.axios.post(`/api/issues/${this.issue.id}/comments`,
